...
public enum FinanceResponseCode {
	...
	FinanceResponseCode(Integer code, String message) {
		this.code = code;
	...
	public static String getMessage(String name) {
		for (FinanceResponseCode item : FinanceResponseCode.values()) {
