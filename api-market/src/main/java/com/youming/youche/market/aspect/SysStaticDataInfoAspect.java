package com.youming.youche.market.aspect;
...
import com.youming.youche.market.utils.ObjConvertUtils;
import com.youming.youche.market.utils.ReadisUtil;
...
public class SysStaticDataInfoAspect {
    ...
    @Pointcut("@annotation( com.youming.youche.market.annotation.Dict)")
