...
public class TenantUserRel extends BaseDomain implements Serializable {

	private static final long serialVersionUID = 3133677707883426091L;
	...
	/**
	 * 推送级别（推送级别 1：普通员工 2:事业部3:大区 4：总裁办） 对应静态数据：PUSH_LEVEL
	 */
