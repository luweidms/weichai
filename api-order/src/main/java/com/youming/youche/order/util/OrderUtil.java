...
/**
 * Created by zhouchao on 18/4/17.
 */
...
//			returnMap.put("vehicleStatus", "需求车型");
    ...
    public static float objToFloatDiv100(Long str){
        if (str != null) {
            return str / 100;
        }else{
            return 0f;
    ...
    public static float objToFloatMul100(Float str){
        if (str != null) {
            BigDecimal bigA = new BigDecimal(str);
            BigDecimal bigB = new BigDecimal(100);
            return bigA.multiply(bigB).floatValue();
     ...
     * @return
     */
    public static long objToLongMul100(Long str){
        if(str != null) {
            BigDecimal bigA = new BigDecimal(str);
            BigDecimal bigB = new BigDecimal(100);
            return bigA.multiply(bigB).longValue();
