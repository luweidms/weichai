...
import static com.youming.youche.conts.EnumConsts.SysStaticData.PRICE_ENUM;
...
*/
    ...
    @TableName("order_fee")
    public class OrderFee extends BaseDomain {
    ...
    private Long afterPayEquivalenceCardAmount;
            ...
            * 现付等值卡类型
            */
    @SysStaticDataInfoDict(dictDataSource = "EQUIVALENCE_CARD_TYPE")
    ...
    private Integer afterPayEquivalenceCardType;
            ...
            * 后付结算类型
            */
    @SysStaticDataInfoDict(dictDataSource ="PAY_ACCT_TYPE")
    ...
    private Long finalFee;
            ...
            * 收入信息 单位
            */
    @SysStaticDataInfoDict(dictDataSource =PRICE_ENUM)
    ...
    private Long exceptionOut;
            ...
            * 到付状态 0 未支付 1 已支付
            */
    @SysStaticDataInfoDict(dictDataSource = "AMOUNT_FLAG")
