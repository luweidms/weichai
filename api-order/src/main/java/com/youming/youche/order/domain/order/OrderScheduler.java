...
import static com.youming.youche.conts.EnumConsts.SysStaticData.DRIVER_TYPE;
...
public class OrderScheduler extends BaseDomain {
     ...
     * 用户类型
     */
    @SysStaticDataInfoDict(dictDataSource = DRIVER_TYPE)
    private Integer carUserType;

    /**
     * 车辆类型
     */
    @SysStaticDataInfoDict(dictDataSource = "VEHICLE_CLASS")
     ...
     * 派单方式（1 竞价 2 抢单 3 指派）
     */
    @SysStaticDataInfoDict(dictDataSource = "APPOINTWAY")
