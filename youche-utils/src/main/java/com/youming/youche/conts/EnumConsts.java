...
public class EnumConsts {
	...
	public static class RemoteCache {
		...
		public static final String UPLOAD_LATITUDE = "UPLOAD_LATITUDE"; // 上传经纬度
																		// rpush/lpop

		public static final String UPLOAD_LATITUDE_G7 = "UPLOAD_LATITUDE_G7"; // 上传经纬度
																				// rpush/lpop

		public static final String UPLOAD_LATITUDE_YL = "UPLOAD_LATITUDE_YL"; // 上传经纬度
																				// rpush/lpop

		public static final String UPLOAD_LATITUDE_BD = "UPLOAD_LATITUDE_BD"; // 北斗上传经纬度
																				// rpush/lpop
		 ...
		 * 智能匹配, 元数据
		 */
		public static final String Match_META_AllRegionKeySet = "AllRegionKeySet"; // 所有发布货源的出发地|到达地key值集合(key:
																					// AllRegionKeySet,
																					// value:
																					// Set[S1|E1,
																					// S1|E2,
		...
		public static final String Match_META_GoodsRegionSet_Profix = "GRegionSet_"; // 发布货源的出发地|到达地有序集合(前缀)(key:
																						// GRegionSet_Si|Ej,
																						// value:
																						// ZSet[G1,
																						// G2,
		...
		public static final String Match_META_CarsRegionSet_Profix = "CRegionSet_"; // 发布车源的出发地|到达地有序集合(前缀)(key:
																					// CRegionSet_Si|Ej,
																					// value:
																					// ZSet[C1,
																					// C2,
		...
		public static final String Match_META_GoodsType_Profix = "GType_"; // 货物类型前缀(key:
																			// GType_G1,
																			// value:
																			// 冷链|生鲜)

		public static final String Match_META_CarsType_Profix = "CType_"; // 车辆类型前缀(key:
																			// CType_C1,
																			// value: 生鲜)

		public static final String Match_META_GoodsLoad_Profix = "GLoad_"; // 货物重量前缀(key:
																			// GType_G1,
																			// value: 10)

		public static final String Match_META_CarsLoad_Profix = "CLoad_"; // 车辆载重前缀(key:
																			// CType_C1,
																			// value: 20)

		public static final String Match_META_GoodsSquare_Profix = "GSquare_"; // 货物平方数前缀(key:
																				// GSquare_G1,
																				// value:
																				// 10)

		public static final String Match_META_CarsSquare_Profix = "CSquare_"; // 车辆平方数前缀(key:
																				// CSquare_C1,
																				// value:
																				// 20)

		public static final String Match_META_GoodsLength_Profix = "GLen_"; // 货物需求长度前缀(key:
																			// GLen_G1,
																			// value: 8)

		public static final String Match_META_CarsLength_Profix = "CLen_"; // 车辆长度前缀(key:
																			// CLen_C1,
																			// value: 10)

		public static final String Match_META_USER_HASH = "GCUserMap"; // 存放发布ID和对应的用户ID(key:
																		// GCUserMap,
																		// value: Map[(G1,
																		// GU_ID1), ...
																		// (Gn, GU_IDn),
		...
		public static final String Match_META_Goods_Priority = "GP_";// 存放货源对应的优先级列表(key:
																		// GP_Gn, value:
																		// 优先级排序|车源ID)

		public static final String Match_META_GoodsRootOrg_Profix = "GOrg_";// 货源对应的顶级组织ID(key:
																			// GOrg_Gn,
																			// value: 201)

		public static final String Match_META_CarsRootOrg_Profix = "COrg_";// 车源对应的顶级组织ID(key:
																			// COrg_Cn,
																			// value: 201)
		 ...
		 * 智能匹配, 结果
		 */
		public static final String Match_Result_TEMP_HASH = "GCMatchedMap"; // 匹配中间结果哈希集合,存放匹配的货源|车源ID和状态(key:
																			// GCMatchedMap,
																			// value:
																			// Map[(G1|C1,
																			// bit位(如：001)),
		...
		public static final String Match_Result_Goods_Profix = "GResult_"; // 货源已匹配结果次数(前缀)(key:
																			// GResult_G1,
																			// value: 5)

		public static final String Match_Result_Cars_Profix = "CResult_"; // 车源已匹配结果次数(前缀)(key:
																			// CResult_C1,
																			// value: 5)

		public static final String Match_Result_Goods_Cars_Profix = "GCResult_"; // 匹配结果重复校验(前缀)(key:
																					// GCResult_G1|C1,
																					// value:
																					// 1)
		...
		public static final String Vehicle_Gps_X_Set = "VGP_X_SHARD_"; // 记录纬度分片(key:
																		// VGP_X_SHARD_分片值,
																		// value:
																		// Set[billId])

		public static final String Vehicle_Gps_Y_Set = "VGP_Y_SHARD_"; // 记录经度分片(key:
																		// VGP_Y_SHARD_分片值,
																		// value:
																		// Set[billId])

		public static final String Vehicle_Gps_Set = "VEHICLE_GPS_SET_"; // 记录经纬度(key:
																			// VGP_X_SHARD_billId,
																			// value:
																			// Set[gps])
		...
		public static final String INVITE_REGISTERE = "INVITE_REGISTERE";// 邀请注册
																			// 1000000001

		public static final String SHORTCUT_REGISTERE = "SHORTCUT_REGISTERE";// 快捷注册
																				// 1000000001

		public static final String BUNDING_PHONENUMBER = "BUNDING_PHONENUMBER";

		public static final String RESET_PAY_PASSWORD = "RESET_PAY_PASSWORD";// 设置支付密码
																				// 1000000076
		...
		public static final String TRANSFER_ACCOUNTS = "TRANSFER_ACCOUNTS";// 转账
																			// 1000000057
		...
		public static final String APPLY_NO = "APPLY_NO";// 车辆费用申请单号
	...
	public static class SmsTemplate {
		...
		/**
		 * 指派订单（第一次）模板 XXX（司机名称）师傅，XXXX（车队简称）给你指派了XX-XX，07-28
		 * 20：00靠台（靠台时间）的订单，请尽快下载登录同心智行APP绑定银行卡收取运费， 下载地址www.xiazai.com (点击可分发到APP
		 * store/下载安卓包)
		 **/
		public static final long FIRST_ORDER_REASSIGN = 4000000009L;

		/**
		 * 临时车队-指派订单 您好，${tenantName}车队给您的车辆${plateNumber}推送了一个订单，
		 * 请登录微信小程序查看详情及提取运费（在微信搜索小程序“同心智行-车队”并关注，您的登录账号是${userPhone}。 [同心智行]
		 **/
		public static final long ORDER_REASSIGN_TEMP = 4000000011L;

		/**
		 * 车辆违章处理通知
		 * 亲爱的${LINK_MAN}用户,您的车牌号${PLATE_NUMBER}存在一个罚款为￥${VIOLATION_FINE}的违章，请尽快处理! [同心智行]
		 **/
		public static final long VIOLATION_NOTIFY_TEMP = 4000000030L;

		/**
		 * 车管操作切换司机通知 ${tenantName}给您指派了订单${orderId}，请按要求完成订单。
		 */
		public static final long TUBE_SWITCH_TEMP = 4000000031L;

		/**
		 * 司机操作切换司机通知 司机${carDriverName}(${carDriverPhone})申请转移订单${orderId}。
		 */
		...
		/**
		 * 审核提醒 尊敬的${auditMan}，${applyMan}申请了一笔${amount}元的${busiName}，单号${busiId}，请审核
		 **/
		public static final long AUDIT_TIP = 5000000001L;

		/**
		 * 油卡充值修改卡号提醒 订单[${orderId}]的充值卡号已被修改，查看详情>>。
		 **/
	...
	public static class SysSmsSendConstant {
		...
		public static final int MARKETING_SMS_SRC_TYPE_0 = 0;// 短信来源；0：单条发送, 1：批量发送,
																// 2：TASK批量发送

		public static final int MARKETING_SMS_SRC_TYPE_1 = 1;// 短信来源；0：单条发送, 1：批量发送,
																// 2：TASK批量发送

		public static final int MARKETING_SMS_SRC_TYPE_2 = 2;// 短信来源；0：单条发送, 1：批量发送,
																// 2：TASK批量发送
	...
	public static class PayInter {
		...
		// 服务商账单
		public static final long SERVICE_PROVIDER_ORDER = 22000038L;

		// 招商对账单
		public static final long INVESTMENT_STATEMENT = 22000039L;

		// 驾驶员工资
		public static final long DRIVER_SALARY = 22000040L;
		...
		/*
		 * //订单业务ID public static final long BUSS_ORDER_CODE = 21000001L;
		 *
		 * //转账业务ID public static final long TRANSFER_CODE=21000004L; //平台发送邀请红包ID public
		 * static final long WALLET_RED_CODE=21000006L; //收款码支付业务ID public static final
		 * long RECEIVE_MONEY_MA=21000007L; //提现反冲业务ID public static final long
		 * WITHDRAWALS_ROLL=21000008L; //验证身份证 public static final long
		 * IDENTITY_CHECK=21000009L; //保证金费用 public static final long
		 * BOND_FEE_CODE=21000012L; //保险反冲 public static final long
		 * INSURANCE_ROLL=21000013L; //积分兑换扣减业务ID public static final long
		 * COST_INTEGRAL=21000014L;
		 *//** 登陆积分赠送 */
		/*
	...
	public static class SubjectIds {
		...
		/*
		 * //可用金额支付维修单 public static final long PAY_REPAIR_BALANCE = 1480L; //未到期金额支付维修单
		 * public static final long PAY_REPAIR_MARGIN = 1481L; //收入账户可用金额维修单 public static
		 * final long INCOME_REPAIR_BALANCE = 1482L; //收入账户未到期金额维修单 public static final
		 * long INCOME_REPAIR_MARGIN = 1483L;
		 */
	...
	public static class TASK_USER {
		...
		/** 进程用户token名称 **/
		public static final String TASK_TOKEN_NAME = "TASK_TOKEN_NAME";
	...
	public static class SUBSIDY_FEE_SUM_STATE {
		 ...
		 * 部分结算
		 */
		public static final Integer PARTIAL_SETTLE = 4;

		/**
		 * 已结算
		 */
		public static final Integer SETTLED = 5;
	}
