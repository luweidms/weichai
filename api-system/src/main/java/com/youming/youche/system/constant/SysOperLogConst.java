...
//		AuditMsg(10, "审核提醒"),
	...
	public enum BusiCode {
		...
		annualReview(100020,"车辆年审"),
		accident(100021,"车辆事故"),

		contract(100022,"合同管理"),
		/**
		 * 订单信息
		 */
	...
	public static void main(String[] args) {
		System.out.println(SysOperLogConst.BusiCode.CustomerLine.getCode());
		System.out.println(SysOperLogConst.BusiCode.CustomerLine.getName());
	}
}
