...
//                    LOGGER.info("请求参数：" + requestContent);
...
//                        response.append(tmp);
//                    }
//                    LOGGER.info("玄武无线科技发送短信：" + response.toString());
//                    if (org.springframework.util.StringUtils.isEmpty(response.toString())) {
//                        throw new com.framework.core.exception.BusinessException("发送失败，返回信息为null");
//                    }
...
//                    if (!"0".equals(code)) {
//                        throw new com.framework.core.exception.BusinessException("发送失败，返回信息为:" + msg);
//                    }
